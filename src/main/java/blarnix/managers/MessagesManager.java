...
import blarnix.libs.centeredmessages.DefaultFontInfo;
...
public class MessagesManager {
	...
	public void sendMessage(CommandSender player,String message,boolean prefix) {
		if(!message.isEmpty()) {
			if(prefix) {
				player.sendMessage(getMessageColor(this.prefix+message));
			}else {
	...
	public static String getMessageColor(String text) {
